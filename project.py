...
source3 = ["“What Is Data Recovery and How Does It Work?” UFS Explorer, LLC SysDev. Laboratories, https://www.ufsexplorer.com/articles/what-is-data-recovery.php", "(UFS Explorer)"]
...
source7 = ["“How Is Data in a Computer Stored?” Data Recovery Specialists, http://www.datarecoveryspecialists.co.uk/blog/how-is-data-in-a-computer-stored", "(Data Recovery Specialists)"]
source8 = ["“ASCII Code - the Extended ASCII Table.” Injosoft AB, https://www.ascii-code.com/", "(The Extended ASCII Table)"]
source9 = ["“There's a Big Difference: SSD vs HDD Speed, Lifespan, and Reliability.” Tekie, 27 Apr. 2021, https://tekie.com/blog/hardware/ssd-vs-hdd-speed-lifespan-and-reliability/", "(Tekie)"]
...
def menuPrompt(menu):
    formatPrint("Press enter when you're done reading to return to the previous menu, or type menu to return to the main menu.\n")
    back = input()
    if back == "menu":
        mainMenu()
    else:
