...
dataRecoveryInForensics = "The main difference between common data recovery and forensic data recovery is the intent. Computer forensics usually refers to locating or recovering data for the sake of an investigation. Common data recovery is simply data recovery in any other context.\n"
...
forensicsInAction = "One example of computer forensics being used in a real case is the case of Matt Baker. He was a minister at Crossroads Baptist Church in Hewitt, Texas. On April 8th, 2006, he called 911 to report that he had found his wife, Kari, unconscious in their bedroom. Because a typed suicide note was found on the dresser next to an empty bottle of sleeping pills, it was ruled as a suicide. However, Kari’s family didn’t believe that she would ever kill herself, so they requested that the situation be re-investigated. Investigators found that, prior to Kari’s death, Matt had used his computer to do research on how to overdose on sleeping pills. They also found phone records of Matt calling Kari’s phone after she had died. Investigators found that Matt had given Kari’s phone to a woman named Vanessa Bulls, who confessed that Matt claimed that he had killed Kari for her. If not for computer forensics, Matt Baker would have gotten away with killing his wife.\n"
